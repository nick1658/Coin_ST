			...
			switch (coin_env.full_stack_num){
				case 1:
					if (coin_env.full_coin_stack[0] < TIPS_SIZE){
						sprintf ((char *)str_buf, "请更换%s的纸筒。", coin_tips[coin_env.full_coin_stack[0]]);
					}else{
						sprintf ((char *)str_buf, "数组越界: %d", coin_env.full_coin_stack[0]);
					}
					break;
				case 2:
					if ((coin_env.full_coin_stack[0] < TIPS_SIZE) && 
						(coin_env.full_coin_stack[1] < TIPS_SIZE)){
						sprintf ((char *)str_buf, "请更换%s和%s的纸筒。", 	coin_tips[coin_env.full_coin_stack[0]], 
																	coin_tips[coin_env.full_coin_stack[1]]);
					}else{
						sprintf ((char *)str_buf, "数组越界: %d, %d", coin_env.full_coin_stack[0], coin_env.full_coin_stack[1]);
					}
					break;
				case 3:
					if ((coin_env.full_coin_stack[0] < TIPS_SIZE) && 
						...
						sprintf ((char *)str_buf, "请更换%s、%s和%s的纸筒。", 	coin_tips[coin_env.full_coin_stack[0]], 
																		coin_tips[coin_env.full_coin_stack[1]], 
																		coin_tips[coin_env.full_coin_stack[2]]);
					}else{
						sprintf ((char *)str_buf, "数组越界: %d, %d, %d", coin_env.full_coin_stack[0], coin_env.full_coin_stack[1], coin_env.full_coin_stack[2]);
					}
					break;
				case 4:
					if ((coin_env.full_coin_stack[0] < TIPS_SIZE) && 
						...
						sprintf ((char *)str_buf, "请更换%s、%s、%s和%s的纸筒。", coin_tips[coin_env.full_coin_stack[0]], 
																		coin_tips[coin_env.full_coin_stack[1]], 
																		coin_tips[coin_env.full_coin_stack[2]], 
																		coin_tips[coin_env.full_coin_stack[3]]);
					}else{
						sprintf ((char *)str_buf, "数组越界: %d, %d, %d, %d", coin_env.full_coin_stack[0], coin_env.full_coin_stack[1], coin_env.full_coin_stack[2], coin_env.full_coin_stack[3]);
					}
					break;
