...
///////////////////////////////////////
// 清分等级
// uint8_t cn0copmaxc0[COINCNUM] = {15,33,40,10}; //20 //
// uint8_t cn0copminc0[COINCNUM] = {30,65,40,20};  //20 
// uint8_t cn0copmaxc1[COINCNUM] = {15,40,40,10};  //60
// uint8_t cn0copminc1[COINCNUM] = {30,50,40,20}; //30
// uint8_t cn0copmaxc2[COINCNUM] = {15,40,40,10}; //40
// uint8_t cn0copminc2[COINCNUM] = {50,40,40,20}; //40
